...
data = {
    'command': [
        'open YouTube','get weather','what is the time','open google',
        'open file manager','open visual studio','open word','microsoft_store','open excel',
        'open powerpoint','open note','open settings','open network settings','open bluetooth settings','open privacy settings',
        'search','open chat','close google','type','press enter','press tab','press escape','press','wikipedia','copy'
    ],
    'intent': [

        'open_YouTube','weather','get_time','open_google',
        'open_file_manager','open_visual_studio','open_word','microsoft_store','open_excel',
        'open_powerpoint','open_one_note','open_settings','open_network_settings','open_bluetooth_settings','open_privacy_settings',
        'search','open_chatgpt','close_google','type','press_enter','press_tab','press_escape','press','wikipedia','copy'
    ]
...
# Train the model
X_train, X_test, y_train, y_test = train_test_split(df['command'], df['intent'], test_size=0.2, random_state=42)
